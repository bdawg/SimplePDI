...
nSubFiles = 68 *2*2
nSubFiles = 4 *2*2
saveFilePref = 'allSummedImsCube_201710_68acqs_COMmeth_subt100_'
...
darkFilename = 'summedDarks_darks_10ms_em20_01_20170903_750-50_Mirror_0.npz'
...
for f in range(0, nSubFiles / 4):
    ...
    for c in range(0, 2):
        ...
        for l in range(0, 2):
            ...
            if bgMode == 2:
                curCubeShiftedSummed = curCubeShiftedSummed - darkFrames[:, :, curChan]
                print('Dark frame subtracted, with median %f' % np.median(darkFrames[:, :, curChan]))
