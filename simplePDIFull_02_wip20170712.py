...
saveFilePref = 'WIP20170712__allSummedImsCube'
...
twoCamMode = False # If true, just reflect chan2 horizontally, not rotate.
...
class inputImages:
    ...
    def makeDiffIms(self, doMask = False, maskRad = 2., maskVal = 1., clim = [], deRotate = True,
                ...
                calMat_PostRot = [], twoCamMode = False):
    ...
    def partialDiffcal(self, calmode):
        ...
        """
        allowedCalmodes = ['1a', '2a', '2b', '3a', '3b', '4a', '5a', '6a']
...
p.plotSingleIm(imType='p',crop=0.5)
plt.pause(0.001)
